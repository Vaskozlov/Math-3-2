...
$
  u(x, y, z) = \
  =limits(integral)_A(0, 0, 0)^B(x, 0, 0) (
    y^2 z^3 - 3
  ...
  = - 3 limits(integral)_A(0, 0, 0)^B(x, 0, 0) dif x + 3 limits(integral)_A(
    x, y, 0
  )^B(x, y, z) x y^2 z^2 dif z - limits(integral)_A(x, y, 0)^B(
    x, y, z
  ) y dif z + 2 limits(integral)_A( x, y, 0 )^B(x, y, z) dif z = \
  = -3x + x y^2 z^3 - y z + 2 z
$

Ответ: $u(x, y, z) = x y^2 z^3 -3x - y z + 2z$
...
$
  limits(integral.cont)_(partial D) f_1(x, y) dif x + f_2(
    x, y
  ) dif y = limits(integral.cont)_xor f_1(x, y) dif x + f_2(x, y) dif y + \
...
#let data_1 = (
  (1.00000000e-01, 4.35783978e-01, 3.56205428e-02, 6.67000000e-07),
  (1.00000000e-02, 4.67410700e-01, 3.99382098e-03, 2.20800000e-06),
  (1.00000000e-03, 4.69078918e-01, 2.32560230e-03, 2.17500000e-05),
  (1.00000000e-04, 4.71159691e-01, 2.44830053e-04, 2.12708000e-04),
  (1.00000000e-05, 4.71382370e-01, 2.21509083e-05, 2.14883300e-03),
  (1.00000000e-06, 4.71403936e-01, 5.84685097e-07, 2.15283750e-02),
  (1.00000000e-07, 4.71404467e-01, 5.37838500e-08, 2.10913042e-01),
  (1.00000000e-08, 4.71404508e-01, 1.26584077e-08, 2.08210563e+00),
)
...
#let data_2 = (
  (1.00000000e-01, 4.74500000e-01, 3.09547921e-03, 1.29200000e-06),
  (1.00000000e-02, 4.71653500e-01, 2.48979209e-04, 4.80830000e-05),
  (1.00000000e-03, 4.71423509e-01, 1.89877090e-05, 4.42229100e-03),
  (1.00000000e-04, 4.71404809e-01, 2.87777500e-07, 4.45000792e-01),
  (1.00000000e-05, 4.71404529e-01, 8.63193722e-09, 4.61828905e+01),
)
...
#let data_4 = (
  (20, 7.34659114e-01, 2.63254594e-01, 2.06250000e-05),
  (50, 4.50291161e-01, 2.11133594e-02, 1.00000000e-06),
  (100, 5.56187054e-01, 8.47825330e-02, 1.91700000e-06),
  (1000, 4.90466570e-01, 1.90620490e-02, 2.27080000e-05),
  (10000, 4.77719674e-01, 6.31515296e-03, 2.17208000e-04),
  (100000, 4.70505090e-01, 8.99431272e-04, 2.10458300e-03),
  (1000000, 4.72151649e-01, 7.47128613e-04, 2.12798750e-02),
  (10000000, 4.72288369e-01, 8.83848303e-04, 2.11331959e-01),
  (100000000, 4.71410944e-01, 6.42344393e-06, 2.14757808e+00),
)
